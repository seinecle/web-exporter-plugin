 ...
 * 
 * @see WebExporter
 * @see WebExporterPanel
 * @author Mathieu Bastian
 */
@ServiceProvider(service = ExporterUI.class)

public class WebExporterUI implements ExporterUI {

    private WebExporterPanel panel;
    private WebExporter exporter;
    
    @Override
    public JPanel getPanel() {
        panel = new WebExporterPanel();
        return panel;
    }

    @Override
    public void setup(Exporter exporter) {
        this.exporter = (WebExporter) exporter;
    ...
    public boolean isUIForExporter(Exporter exporter) {
        return exporter instanceof WebExporter;
    }
    @Override
